...
CI_PACKAGE_EXCLUDES=(
	...
	--exclude 'pallet-contracts-mock-network'
	--exclude 'pallet-minimal-template'
	--exclude 'pallet-parachain-template'
	--exclude 'pallet-staking-async*'
	--exclude 'pallet-xcm*'
	...
	--exclude 'yet-another-*'
	--exclude 'zombienet-*'
	--exclude 'equivocation-detector'
	--exclude 'erasure_coding_fuzzer'
	--exclude 'finality-relay'
	--exclude 'pallet-example*'
	--exclude 'pallet-ahm-test'
	--exclude 'messages-relay'
	--exclude 'relay-utils'
	--exclude 'staging-node-cli'
	--exclude 'staging-tracking-allocator'
	--exclude 'node-rpc'
	--exclude 'node-bench'
